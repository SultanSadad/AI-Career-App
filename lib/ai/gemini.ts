...
// 1. Prompt Optimasi Deskripsi Pengalaman Kerja
...
// 3. Prompt Evaluasi Holistic Profile Match
...
3. Formulate a crisp "verdict" (e.g. "Strong Candidate", "Moderate Fit", "Needs Upskilling").
4. Identify candidate's top "strengths" (why they are a strong fit).
5. Identify candidate's critical "weaknesses" or qualification gaps.
6. Extract "matchingSkills" and "missingSkills".
7. Formulate clear, actionable "strategicRecommendations" to optimize their chances of landing this job.
